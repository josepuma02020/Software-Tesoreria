            ...
            <div class="tabla-registros">
                ...
                <form action="" method="post">
                    <div class="form-row formulario">
                        ...
                        <button title="Exportar informe excel" type="button" id="excel" class="btn btn-success">
                    ...
                    <TBODY>
                        ...
                        ?>
                            <TR style="background-color: <?php echo $color ?> ;">
                                ...
                                ?>
                                <td> <input <?php echo $revisado ?> disabled id="check" type="checkbox" aria-label="Checkbox for following text input"></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#excel').click(function() {
            ...
            desde = $('#desde').val();
            hasta = $('#hasta').val();
            location.href = `./facturas/exportarexcel.php?desde=${desde}&hasta=${hasta}`;
        });
