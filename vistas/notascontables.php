            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        ?>
                            <td>
                                <button title="Eliminar Registro" style="height:1.5rem;padding-top:0 " onclick="agregaridregistro(<?php echo $filasregistros['idregistro'] ?>)" id="eliminarregistro" class="btn btn-danger" data-toggle="modal" data-target="#eliminar">
