        ...
        <main style="max-width:90% ;" class=" container container-md">
            ...
            <div class="tabla-registros">
                ...
                <table id="registrosnotas" class="table table-striped  table-responsive-lg usuarios ">
                    ...
                    <tbody>
                        <?php
                        $consultatipos = "select * from tiposfactura";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button onclick="datostipofactura('<?php echo $filas['idtipo'] ?>','<?php echo $filas['tipofactura'] ?>')" type="button" title="Editar tipo de documento" id="detalles" class="btn btn-primary" data-toggle="modal" data-target="#editar">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                        </svg>
                                    </button>
                                    <button onclick="datostipofactura('<?php echo $filas['idtipo'] ?>','<?php echo $filas['tipofactura'] ?>')" type="button" title="Eliminar tipo de documento" id="delete" class="btn btn-danger" data-toggle="modal" data-target="#eliminar">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#guardartipofactura').click(function() {
            a = 0;
            id = $('#idu').val();
            tipofactura = $('#tipofacturau').val();
            if (tipofactura == '' || tipofactura.length < 2) {
                a = 1;
                alertify.alert('ATENCION!!', 'El valor del tipo de factura debe tener mínimo 2 letras. ', function() {
                    alertify.success('Ok');
                });
            }
            if (a == 0) {
                editartipofactura(id, tipofactura);
                setTimeout(function() {
        ...
        $('#registrar').click(function() {
            ...
            if (tipo == '' || tipo.length < 2) {
                a = 1;
                alertify.alert('ATENCION!!', 'Favor llenar el campo de cuenta contable(Debe tener mas de dos caracteres). ', function() {
                    alertify.success('Ok');
                });
            }
            if (a == 0) {
                registrartipofactura(tipo);
                setTimeout(function() {
                    window.location.reload();
                }, 1000);
            }
