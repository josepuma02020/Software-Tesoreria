...
?>
    ...
    <head>
        ...
        <SCRIPT lang="javascript" type="text/javascript" src="./clasificacionesdocumento/clasificaciones.js"></script>
        <SCRIPT src="librerias/alertify/alertify.js"></script>
        <title>Clasificación de documentos</title>
    </head>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Registrar nueva clasificación de documento</h5>
                                ...
                                <form action="">
                                    <div class="form-row formulario">
                                        <div class="form-group grande">
                                            <label for="hasta">Clasificación de documento:</label>
                                            <input style="text-align:center" class="form-control " id="clasificacionn" name="clasificacionn" type="text">
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <table id="registrosnotas" class="table table-striped  table-responsive-lg usuarios ">
                    <thead>
                        <tr>
                            ...
                            <th> Clasificacion de documento </th>
                            <th> Acciones </th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $consultatipos = "select * from clasificaciones";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!-- <button onclick="datosclasificacion('<?php echo $filas['idclasificacion'] ?>','<?php echo $filas['clasificacion'] ?>')" type="button" title="Editar tipo de documento" id="detalles" class="btn btn-primary" data-toggle="modal" data-target="#editar">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                                        </svg>
                                    </button> -->
                                    <button onclick="datosclasificacion('<?php echo $filas['idclasificacion'] ?>','<?php echo $filas['clasificacion'] ?>')" type="button" title="Eliminar clasificación de documento" id="delete" class="btn btn-danger" data-toggle="modal" data-target="#eliminar">
                ...
                <div class="modal fade" id="eliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h6>Esta seguro que desea eliminar esta clasificación de documento?</h6>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                ...
                                <form action="">
                                    <div class="form-row formulario">
                                        <div class="form-group mediano-grande">
                                            <input disabled style="text-align:center" class=" form-control " id="id" name="id" type="hidden">
                                        </div>
                                        <div class="form-group mediano-grande">
                                            <label for="hasta">Descipcion de Cuenta:</label>
                                            <input style="text-align:center" class="form-control " id="clasificacion" name="clasificacion" type="text">
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#registrar').click(function() {
            ...
            clasificacion = $('#clasificacionn').val();
            if (clasificacion == '') {
                a = 1;
                alertify.alert('ATENCION!!', 'Favor llenar el campo de clasificación de documento', function() {
                    alertify.success('Ok');
                });
            }
